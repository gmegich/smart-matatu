...
CREATE TABLE IF NOT EXISTS payments (
  ...
  status TEXT DEFAULT 'pending' CHECK (status IN ('pending', 'verified', 'expired', 'cancelled')),
...
BEGIN
  ...
  INSERT INTO trips (vehicle_id, driver_id, route_id, sacco_id, status, is_full, started_at)
  VALUES (p_vehicle_id, auth.uid(), p_route_id, v_sacco_id, 'active', false, NOW())
