-- Allow passengers to book in either direction (e.g. Lanet -> Nakuru CBD)
-- Fares are symmetric: if the exact from->to fare is missing, fall back to the reverse pair.
