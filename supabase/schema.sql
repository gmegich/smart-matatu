...
CREATE INDEX IF NOT EXISTS idx_payments_passenger_status_created ON payments(passenger_id, status, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_payments_sacco_status_created ON payments(sacco_id, status, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_driver_assignments_driver_active ON driver_assignments(driver_id, is_active);
